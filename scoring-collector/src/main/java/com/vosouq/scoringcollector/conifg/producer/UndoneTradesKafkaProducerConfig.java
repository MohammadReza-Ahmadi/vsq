...
public class UndoneTradesKafkaProducerConfig {

    @Value(value = "${kafka.bootstrapAddress}")
    private String bootstrapAddress;

    @Bean
    public ProducerFactory<String, UndoneTradePayload> undoneTradesProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, UndoneTradePayload> undoneTradesKafkaTemplate() {
        return new KafkaTemplate<>(undoneTradesProducerFactory());
    }
}
