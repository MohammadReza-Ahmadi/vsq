 ...
 *         &lt;element name="preNo" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
...
@XmlRootElement(name = "GetAddressAndPostcodeByTelephone")
public class GetAddressAndPostcodeByTelephone {
     ...
     * 
     */
    public void setPreNo(int value) {
        this.preNo = value;
    }
