...
# features are this
# the other columns include year and country and value which are not included when selecting columns

app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    # a div to separate the figure from the selective stuff.
    # good practice and needs to be done.
    html.Div([
        # selective stuff.
        html.Div([
            dcc.Dropdown(
    ...
    # close the first div to start the graph.
