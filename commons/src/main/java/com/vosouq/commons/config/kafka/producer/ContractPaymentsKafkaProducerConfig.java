...
public class ContractPaymentsKafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, ContractPaymentPayload> paymentsProducerFactory() {
        Map<String, Object> configProps = getConfigProps(bootstrapAddress);
        return new DefaultKafkaProducerFactory<>(configProps);
    }

    @Bean
    public KafkaTemplate<String, ContractPaymentPayload> paymentKafkaTemplate() {
